ant to override the default and either define another size relative to this one,
     * or a fixed one.
     *
     * @defaultValue `"small"`
...
thod on all the properties you execute with fast-check.
     *
     ...
     * For some arbitraries users will w