 using options object API for flag permutations ([@kpdecker](https://api.github.com/users/kpdecker))
...
- [#72](https://github.com/kpdecker/jsdiff/issues/72) - Consider