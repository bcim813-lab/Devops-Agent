 ...
 */
import type { PagerDutyAlert, Runbook, IncidentRef, RunbookError, Result } from "../types/models";
export interface Incident_Agent {
     ...
     */
    executeRunbook(runbook: Runbook, incident: IncidentRef): Promise<Result<void, RunbookError>>;
    /**
...
//# sourceMappingURL=Incident_Agent.d.ts.map