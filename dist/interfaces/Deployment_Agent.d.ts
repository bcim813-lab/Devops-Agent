 ...
 */
import type { DeploymentCommand, RolloutHandle, RolloutStatus, DeploymentRef, DeployError, RollbackError, Result } from "../types/models";
...
export interface Deployment_Agent {
     ...
     */
    applyManifest(command: DeploymentCommand): Promise<Result<RolloutHandle, DeployError>>;
    /**
     ...
     */
    initiateRollback(deployment: DeploymentRef): Promise<Result<void, RollbackError>>;
    /**
...
//# sourceMappingURL=Deployment_Agent.d.ts.map