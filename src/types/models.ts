...
export type Option<T> = { present: true; value: T } | { present: false };
...
export const none: Option<never> = { present: false };
...
export class HaltedError extends Error {
  constructor(
    ...
    public readonly haltedAt: ISO8601String,
    public readonly reason: string
  ) {
    super(
      `Deployment '${deploymentName}' in namespace '${namespace}' is halted since ${haltedAt}: ${reason}`
    );
...
// ---------------------------------------------------------------------------
// Additional aliases used in agent interfaces
// ---------------------------------------------------------------------------
